...
<div class="row post-sections" id="view-section" style="min-height:500px;">
	<div class="large-12 medium-12 small-12 columns">
		...
		<hr>
		<a class="post-btn" id="edit-posts" href="{{ URL::route('edit_workdata', array($post->id)) }}" style="display: inline-block;">Edit</a>
		<hr>
			{!! Form::open(array('url'=>'workdata/delete', 'method'=>'DELETE', 'style'=>'display:inline;')) !!}

			{!! Form::text('filename', $post->work_image) !!}<br />
